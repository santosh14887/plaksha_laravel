...
<nav class="page-breadcrumb">
			<ol class="breadcrumb">
				...
				@if($user_data['type'] == 'admin')
					...
					<li class="breadcrumb-item active" aria-current="page"><a href="{{ url('/transaction/employee/1') }}">Company Transactions</a></li>
				@else
					<li class="breadcrumb-item active" aria-current="page">Users</li>
					@if($user_data['type'] == 'employee')
						<li class="breadcrumb-item active" aria-current="page"><a href="{{ url('/employees') }}">Employee</a></li>
						@else
...
<div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
			  <div class="card-header"> @if($user_data['type'] != 'admin')
				  <a href="{{ ($user_data['type'] == 'employee') ? url('employees') : url('brokers') }}" title="Back"><span class="btn btn-warning btn-sm"><i class="fa fa-arrow-left" aria-hidden="true"></i> Back</span></a>
					 @endif  Transactions for (<b>{{ $user_data['name'] }}</b>) Current Amount :- {{ $user_data['current_amount']}}<span class="float_right">
					@if(request('search') != '')
			...
			<div class="row">
				<div class="col-md-3">
					<input type="button" id="trans_action" data-table="users" value="Submit" class="btn btn-primary trans_action me-2">
				</div>
				<div class="col-md-9">
