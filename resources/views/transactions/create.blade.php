...
<div class="row">
	<div class="col-md-12 grid-margin stretch-card">
		<div class="card">
		<div class="card-body">
			<h4 class="card-title">{{ __('Add Employee') }}<span class="float_right"><a href="{{ URL::to('employees') }}">View All Employee</a></span></h4>
			...
			<div class="form-group row">
				...
				<!--<div class="col-md-6">
					...
					{{ Form::text('load_per', Input::old('load_per'), array('class' => 'form-control')) }}
			...
			{{ Form::submit('Add Employee!', array('class' => 'btn btn-primary me-2')) }}
