...
<nav class="page-breadcrumb">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">Roles List<span class="float_right">
				  @if(request('search') != '')
					<a href="{{ url('/roles') }}" title="Remove Filter"><button class="btn btn-warning btn-sm"><i class="fa fa-refresh" aria-hidden="true"></i> Remove Filter</button></a>
					@endif
					@if( Auth::user()->can('viewMenu:ActionRoles') || Auth::user()->can('viewMenu:All') || Auth::user()->type == 'admin')
					<a href="{{ url('/roles/create') }}" class="btn btn-success btn-sm" title="Add New Permission">
