                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <table class="border_cls" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        <td>{{ $dispatch_data['get_customer']['address'] }}
                                        </td>
                                    </tr>
                                </table><br />
                                <table class="border_cls" cellpadding="0" cellspacing="0">
            ...
            <tr class="information">
                <td colspan="2">
                    ...
                    <table class="border_cls" cellpadding="0" cellspacing="0" style="width:100%">
                        ...
                        @endphp
                        <tr>
                            <td>{{ $d_val['unit_vehicle_number'] }}</td>
                            <td> {{ ($dispatch_data_val['job_type'] == 'load') ? 'Load' : 'Hourly'}}</td>
                            <td>{{ date('d/m/Y',strtotime($dispatch_data_val['start_time']))}}</td>
                            <td>{{ $dispatch_data_val['start_location'] }}</td>
                            <td>{{ $dispatch_data_val['dump_location'] }}</td>
                            <td>{{ $d_val['ticket_number']}}</td>
                            <td> {{ $total_load_hour }}</td>
                            <td>{{ $dispatch_data_val['job_rate'] }}</td>
                            <td>${{ $total_income }}</td>
                        </tr>
                        @php
                        }
                        ...
                        <tr>
                            <td colspan="7" style="text-align:center;">HST on Sale</td>
                            <td>{{$hst_per}}%</td>
                            <td>${{ $hst_per_amt }}</td>
                        </tr>
                    </table>
