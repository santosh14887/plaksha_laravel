...
<div class="row">
	<div class="col-md-12 grid-margin stretch-card">
		<div class="card">
		<div class="card-header">Add Broker</div>
		<div class="card-body">
			
			
			{{ Form::open(array('url' => 'brokers')) }}
			<div class="row">
				<div class="col-sm-4">
					<div class="mb-3">
			...
			<div class="form-group row">
				<div class="col-sm-4">
					...
					{!! $errors->first('incorporation_name','<span class="help-inline text-danger">:message</span>') !!}
					</div>
				</div>
				@php
			...
			<div class="form-group">
				{{ Form::submit('Add Broker!', array('class' => 'btn btn-primary me-2')) }}
				<a href="{{ url('brokers') }}" title="Back"><span class="btn btn-warning btn-sm"><i class="fa fa-arrow-left" aria-hidden="true"></i> Back</span></a>
				{{ Form::close() }}
			</div>
		</div>
		</div>
