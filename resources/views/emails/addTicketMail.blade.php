...
<body topmargin="0" rightmargin="0" bottommargin="0" leftmargin="0" marginwidth="0" marginheight="0" width="100%" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; width: 100%; height: 100%; -webkit-font-smoothing: antialiased; text-size-adjust: 100%; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; line-height: 100%;
	...
	max-width: 560px;" class="wrapper">
			...
			padding-bottom: 20px;">
                            ...
                            <!-- PREHEADER -->
                            <a target="_blank" style="text-decoration: none;" href="javascript:void(0)"><img border="0"
                                    vspace="0" hspace="0" src="{{ url('/') }}/images/logo.png"
                                    style="
				color: #000000;
	...
	max-width: 560px;" class="container">
			...
			font-family: sans-serif;" class="paragraph">
                            New Ticket Added. Details given below
                        </td>
                    </tr>
                    <!-- Set line color -->
                    <tr>
			...
			font-family: sans-serif;" class="paragraph">
                            <table border='1' cellspacing='5' cellpadding='5' style='width:100%'>
                                ...
                                <tbody>
                                    <tr>
                                        <td class='text-center' style='text-align:center;'>{{$mailData['user_name']}}
                                        </td>
                                        <td class='text-center' style='text-align:center;'>{{$mailData['user_email']}}
                                        </td>
                                        <td class='text-center' style='text-align:center;'>{{$mailData['ticket']}}</td>
                                        <td class='text-center' style='text-align:center;'>{{$mailData['dispatch']}}
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
